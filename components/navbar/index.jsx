    ...
    return (
        <div>
            <nav className='fixed top-0 left-0 w-full flex items-center justify-between h-13 py-4 px-6 shadow-md border-b border-gray-200 bg-customWhite z-10'>
                <Image src="/logo.jpeg" width={100} height={200} alt="logo mauatroca" />
                ...
                <Link className={`${buttonVariants({ variant: "outline" })} bg-customOrange text-white hover:bg-customBlue mt-2 rounded-xl`} href="/login" >Trocar de Sala</Link>
                </div>
            </nav>
        </div>
    );
